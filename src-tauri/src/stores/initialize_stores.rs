...
pub fn initialize_stores(app: AppHandle<Wry>) -> Result<(), Box<dyn Error>> {
    ...
    let store_app_apis = tauri_plugin_store::StoreBuilder::new(&app, "app_apis.json")
    ...
    let store_app_settings = tauri_plugin_store::StoreBuilder::new(&app, "app_subscriptions.json")
        .auto_save(Duration::from_millis(100))
