//! # ChartBuddha library
//! - Module: `get_public_product_book`
...
//! ##### provider/coinbase/api/public/get_public_product_book.rs
//
// Rust
use std::error::Error;
...
pub async fn get_public_product_book(
    ...
    let url = format!(
        "https://api.coinbase.com/api/v3/brokerage/market/product_book?product_id={}",
        product_id
    );
