    ...
    <div className={Style.Page_Coinbase_Api}>
      <div className={Style.Top_Container}>
        <div className={Style.Text_Container}>
          <div className={Style.Text_Title}>Coinbase API Settings</div>
        ...
        <div className={Style.Result_Container}>
          <div className={Style.Result_Title}>Api Permissions</div>
          <div>
            {actionResult && (
              <div>
                <pre
                  className={`${Style.Result_Text} ${
                    actionResult.includes('ApiKeyPermissionsResponse') || actionResult.includes('true')
                      ? Style.success
                      : Style.error
                  }`}
                >
